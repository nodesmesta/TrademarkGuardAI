                    ...
                    {allViolations.slice(0, 50).map((v, i) => (
                      <tr key={i} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        <td className="py-2 pr-4">
                          <span className={`inline-block px-2 py-0.5 rounded text-white text-xs font-medium ${PLATFORM_COLORS[v.platform] ?? 'bg-gray-400'}`}>
                            {v.platform}
                          </span>
                        </td>
                        ...
                        <td className="py-2">
                          {v.url ? (
                            <a href={v.url} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline truncate block max-w-xs">
                              {v.url}
                            </a>
                          ) : '—'}
                        </td>
